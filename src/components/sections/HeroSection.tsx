...
//           <div className="w-20 h-[1.5px] bg-gradient-to-r from-transparent via-[#E7C89C] to-transparent mb-10 mx-auto opacity-80" />

//           <h1 className="font-heading text-3xl md:text-5xl lg:text-6xl font-medium leading-[1.15] tracking-[-0.01em] text-gold-gradient">
//             Buy Investment Property in Australia with the Right Strategy
//           </h1>

//           <p className="mt-6 font-body text-[#E7C89C] text-sm md:text-base font-medium tracking-[0.18em] uppercase">
...
//             className="px-8 py-3 text-[11px] font-body font-medium tracking-[0.18em] uppercase rounded-md border border-[#E7C89C] text-[#E7C89C] 
...
//           >
//             <button
//               className="px-8 py-3 text-[11px] font-body font-medium tracking-[0.18em] uppercase rounded-md border border-[#E7C89C]/40 text-[#E7C89C] 
