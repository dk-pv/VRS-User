    ...
    <section className="relative py-16 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="mb-10">
          ...
          <h2 className="xt-xl md:text-3xl font-medium text-white tracking-[-0.01em]">
        ...
        <div className="space-y-6">
          {webinars.map((webinar) => {
            return (
              ...
              >
                {/* TITLE */}
                <h3 className="text-lg md:text-xl text-white font-medium tracking-tight mb-4">
                  {webinar.title}
                </h3>
                ...
                <div className="flex items-center justify-center gap-2.5 mb-3 text-gray-300 text-sm">
                  ...
                  <span className=" text-white text-[11px] tracking-[0.18em] uppercase">
                    {webinar.day}
                  </span>
                </div>
                ...
                {/* DESCRIPTION */}
                <p className=" text-gray-400 max-w-md mx-auto mb-6 text-sm leading-relaxed tracking-wide">
                  {webinar.description}
                </p>
