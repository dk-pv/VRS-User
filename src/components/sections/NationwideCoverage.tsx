    ...
    <section className="relative bg-[var(--background)] py-14 md:py-16 overflow-hidden">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <div className="w-10 h-[2px] bg-[var(--primary-gold)] mx-auto mb-3" />
        ...
        {/* MAP CARD */}
        <div className="relative w-full max-w-3xl mx-auto rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-[0_10px_40px_rgba(0,0,0,0.6)]">
            ...
            {states.map((state, index) => (
              ...
              >
                <div className="relative flex flex-col items-center">
                  ...
                  {/* DOT */}
                  <span className="relative h-3 w-3 rounded-full bg-[var(--primary-gold)] shadow-[0_0_10px_rgba(231,200,156,0.8)] border border-white/40" />

                  {/* LABEL */}
                  <div className="mt-2 px-2.5 py-0.5 text-[9px] md:text-[10px] bg-[#221F1F]/90 text-white rounded-full border border-[var(--card-border)] backdrop-blur-md whitespace-nowrap">
